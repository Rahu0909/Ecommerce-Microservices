...
import com.ecom.microservice.app.clients.ProductServiceClient;
import com.ecom.microservice.app.clients.UserServiceClient;
...
import com.ecom.microservice.app.repository.CartItemRepository;
...
public class CartItemService {
    ...
    public boolean addToCart(String userId, CartItemRequest request) {
        ...
        CartItem exisitingCartItem = cartItemRepository.findByUserIdAndProductId(userId, request.getProductId());
        if (exisitingCartItem != null) {
            //update the quantity
            exisitingCartItem.setQuantity(exisitingCartItem.getQuantity() + request.getQuantity());
            exisitingCartItem.setPrice(BigDecimal.valueOf(1000.00));
